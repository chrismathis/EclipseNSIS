...
public class HTMLExporter
{
    ...
    private void writeHTML(File file, IProgressMonitor monitor)
    {
        try {
			...
			String styleText = makeStyle((style & SWT.BOLD) > 0, (style & SWT.ITALIC) > 0, false,
					false, mStyledText.getForeground(), mStyledText.getBackground());
            if(styleText != null) {
            ...
            IVerticalRuler ruler = mEditor.getAdapter(IVerticalRuler.class);
            if(ruler == null) {
